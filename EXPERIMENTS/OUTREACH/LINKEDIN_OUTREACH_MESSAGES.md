LinkedIn Outreach Messages — RelayPoint Pilot

Context: Use for poll hand-raisers and targeted 10–20 prospect outreach. Personalize tokens in brackets [] before sending.
...
If they push back on deposit:
Totally understood. We can hold the slot pending a short triage call; deposit just helps prioritize limited pilot spots and is fully refundable if you cancel 7+ days before start or if you choose not to proceed after the pilot.

Objection: "We don't have bandwidth"
I get it. The triage call is 15 minutes and we handle most of the setup; we can limit manager time and do the rest via the point person you choose. If useful I can step through exact tasks to minimize disruption.

Close / Ask for Commitment (on call):
We’ll run a 6-week pilot focused on [top pain]. If you’re happy, we can reserve a slot now — either schedule the kickoff or I can send the $250 deposit link to hold your place.
